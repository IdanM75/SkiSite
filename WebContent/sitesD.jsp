			...
			try 
	  		{
				...
				String mySQL = "DELETE FROM idanS WHERE name='" + nameToDelete  + "'";
				...
				//שלב ה: עדכון מסד הנתונים
		  		...
		  		if (n > 0) // כלומר נמצא מישהו ואולי נמצאו יותר מ- 1
                  	...
                  	{
                	  out.print("<h2>");
                      out.print("האתר לא נמצא") ;
                      out.print("</h2>");
                      out.print("<br />");		
              		  out.print("<h3><font color='blue'><a href ='sites.jsp' >למחיקת אתר לחץ כאן </a></font></h3>");
                  	}	
